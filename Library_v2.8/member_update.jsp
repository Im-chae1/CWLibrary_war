		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="member_updateAction.jsp?userID=<%=userID%>">
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="성명" name="userName" maxlength="20" value="<%=user.getUserName()%>">
					</div>
					<div class="form-group">
						<input type="tel" class="form-control" placeholder="휴대폰(010-0000-0000)" name="userTel" maxlength="15" value="<%=user.getUserTel()%>">
					</div>
					<div class="form-group">
					...
					<input type="submit" class="bin btn-primary form-control" value="수정">
				</form>
			</div>
		</div>
	</div>
